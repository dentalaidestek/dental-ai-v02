...
SOURCES = {
    ...
    "periapical_endo_perio_534": TrainingSource(
        key="periapical_endo_perio_534",
        access="public_kaggle_research",
        locator="https://www.kaggle.com/dsv/2664831",
        modality="PERIAPICAL",
        target_signals=("APICAL_PERIODONTITIS_PAI","PERIODONTAL_LESION_HELPER"),
        note="534 periapical radiographs labelled by an experienced radiologist and dentist into five endodontic/periodontal lesion groups. Useful auxiliary positive material; not an exhaustive normal-negative source.",
    ),
    "memosa_oral_mucosa_30039": TrainingSource(
        key="memosa_oral_mucosa_30039",
        access="workbench_gated_mixed_cc",
        locator="https://workbench.memosa.my",
        modality="INTRAORAL_PHOTO",
        target_signals=("ORAL_MUCOSAL_LESION_CANDIDATE","WHITE_ORAL_LESION_CANDIDATE","RED_ORAL_LESION_CANDIDATE","ORAL_ULCER_CANDIDATE"),
        note="MeMoSA 2026: 30,039 clinically labelled oral mucosa images from five countries, including explicit no-lesion cases. Access through MeMoSA Workbench; source cohorts have CC BY 4.0 or CC BY-NC 4.0 terms.",
    ),
    "oral_conditions_10735": TrainingSource(
        key="oral_conditions_10735",
        access="public_research_dataset_verify_primary",
        locator="https://pmc.ncbi.nlm.nih.gov/articles/PMC13366888/",
        modality="INTRAORAL_PHOTO",
        target_signals=("CALCULUS","VISIBLE_CARIES","GINGIVAL_INFLAMMATION","ORAL_ULCER_CANDIDATE","TOOTH_DISCOLORATION","HYPODONTIA_CANDIDATE"),
        note="10,735-image six-condition oral dataset reported with a fixed 1,077-image test split. Use only after the primary downloadable artifact and duplicate/original-image provenance are verified.",
    ),
    "denpar_periapical": TrainingSource(
        key="denpar_periapical",
        access="public_zenodo",
        locator="https://zenodo.org/records/16645076",
        modality="PERIAPICAL",
        target_signals=("PERIODONTAL_BONE_LEVEL_HELPER","TOOTH_SEGMENTATION_HELPER"),
        note="DenPAR v3: public IOPA archive with 1,000 radiographs, CEJ/apex/bone-level keypoints, tooth boxes and segmentation. Useful for periapical structure/bone-loss tests; not APICAL_PERIODONTITIS GT.",
    ),
    "mopg7_pan": TrainingSource(
        key="mopg7_pan",
        access="public_mendeley",
        locator="https://data.mendeley.com/datasets/r43v452t29/4",
        modality="PANORAMIC",
        target_signals=("MISSING_TOOTH","CROWN","ROOT_CANAL_TREATED","CARIES","IMPACTED_THIRD_MOLAR","RESIDUAL_ROOT"),
        note="MOPG-7 v4: expert-reviewed panoramic YOLO/COCO labels plus healthy OPG cases. Use official split metadata and preserve test isolation.",
    ),
    "dentalopg1550": TrainingSource(
        key="dentalopg1550",
        access="public_mendeley",
        locator="https://data.mendeley.com/datasets/rtt726b26d/1",
        modality="PANORAMIC",
        target_signals=("BRIDGE","CROWN","CARIES","FILLING","MISSING_TOOTH","ROOT_CANAL_TREATED","UNERUPTED_TOOTH","PERIAPICAL_RADIOLUCENCY"),
        note="DentalOPG-1550: 1,550 panoramic images with multi-condition labels. Image-level labels only unless downloadable annotations prove localization.",
    ),
    "tl_pano": TrainingSource(
        key="tl_pano",
        access="public_zenodo",
        locator="https://zenodo.org/records/18715533",
        modality="PANORAMIC",
        target_signals=("TOOTH_SEGMENTATION_HELPER","FDI_HELPER","BONE_LOSS_GENERIC","DENTAL_RESTORATION"),
        note="TL-pano: tooth/FDI/alveolar-bone instance segmentation. Supporting structural GT; do not reinterpret composite class as a specific disease.",
    ),
    "intraoral_crack_2026": TrainingSource(
        key="intraoral_crack_2026",
        access="public_zenodo",
        locator="https://zenodo.org/records/21921437",
        modality="INTRAORAL_PHOTO",
