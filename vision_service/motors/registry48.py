...
_SPECS = [
    ...
    MotorSpec("CARIES", "direct", ("findings9", "oralguard4:caries"), "Findings9 direct caries detector with OralGuard 4-class caries evidence."),
    MotorSpec("DEEP_CARIES", "direct_fallback", ("oralguard4:deep_caries", "tvem11:Deep Caries", "caries_depth_geometry"), "OralGuard direct deep-caries evidence with TVEM and pulp-proximity geometry fallback."),
    ...
    MotorSpec("PERIAPICAL_RADIOLUCENCY", "direct", ("findings9", "oralguard4:periapical_lesion", "panoreader_periapical"), "Findings9/OralGuard direct periapical-lesion evidence with Panoramic Reader fallback."),
